...
public class Demo2_1 {
    ...
    public static void main(String[] args) {
        ...
        for (int num = 10; num < 1 || num > 5; ) {
            ...
            num = sc.nextInt();
            if (num == 1) System.out.println("您选择了wow");
            else if (num == 2) System.out.println("您选择了传奇");
            else if (num == 3) System.out.println("您选择了梦幻西游");
            else if (num == 4) System.out.println("您选择了永恒之塔");
            else if (num == 5) System.out.println("您选择了七龙珠ol");
            else System.out.println("您输入的游戏编号无效，请重新输入！！");
        }
